...
export const { addNewTask, toggleHideDone, doneTask, removeTask, allTasksDone } = tasksSlice.actions; // addNewTask to jest action creator, stworzony przez createSlice
